export default function handler(req, res) {
  ...
  // 🎯 FIX 1: Mini app URL for frame button (NOT raw audio)
...
<head>
    ...
    <!-- 🎯 FIXED: Use placeholder image that actually works -->
    ...
    <meta property="twitter:description" content="Listen to this voice message created with VoiceCaster" />
    <meta property="twitter:image" content="${frameImageUrl}" />
    
    <!-- 🎯 FIXED: Farcaster Frame Meta Tags -->
